...
$("#addPackageBtn").on("click", function (e) {
    ...
    $total.html(formPriceString(4000 + getData($(":radio[name='eventAppPackageTotal']:checked"), "price") + getData($(":radio[name='streamingPackage']:checked"), "price") + getSliderPrice($("#rangeSlider"))));
});
...
$("#rangeSlider").on("input", function (e) {
    ...
    sliderVal = price;
    $total.html(formPriceString(4000 + price + getData($(":radio[name='eventAppPackageTotal']:checked"), "price") + getData($(":radio[name='streamingPackage']:checked"), "price") + getSliderPrice($("#rangeSlider"))));
});
...
$(".rangeSlider").on("input", function (e) {
    ...
    let n = i + getData($(":radio[name='eventAppPackage']:checked"), "price");
